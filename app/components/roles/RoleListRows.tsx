...
export default function RolesListRows({ roles, onEdit }: RolesListRowsProps) {
  if (roles.length === 0) {
    return (
      <Box
        sx={{
      ...
      >
        <Typography color="textSecondary">Nenhum perfil encontrado.</Typography>
      </Box>
    );
  }
